...
const CLOUDS_CLOUDS =
          'Color|r,255,g,255,b,255,a,255|Fragmentation|3.0000|Transformation|0.1050|Relief|'+
          'false|Density|0.5200|TranslationSpeed|-0.0050|ThresholdTop|0.4651|ThresholdBotto'+
          'm|0.4651|ThresholdRight|0.0001|ThresholdLeft|0.0001';
type
...
//  '  uniform float uTransformation = 0.0;'#10+  // [0..1]
  ...
  '  brightness *= fade;'#10+ // pow(fade, 2.0);'#10+
...
private
  ...
  procedure SetTimeAccu(AValue: single);
...
public
  ...
  property TimeAccu: single read GetTimeAccu write SetTimeAccu;
end;
...
begin
  FShaderName := 'TOGLCCloudsRenderer';
...
function TOGLCSpriteClouds.GetTimeAccu: single;
begin
  Result := FParams.TimeAccu;
end;
...
procedure TOGLCSpriteClouds.SetTimeAccu(AValue: single);
begin
  FParams.TimeAccu := AValue;
end;
