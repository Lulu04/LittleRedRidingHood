...
private
  ...
  FSaturation, // 0.850
  FOpacityTheshold, // 0.4
  FNormalOpacity: single; // 1.0
  FChanged: boolean;
  function GetChanged: boolean;
  procedure SetBrightness(AValue: single);
  procedure SetDarkmatter(AValue: single);
  procedure SetDistFading(AValue: single);
  procedure SetNormalOpacity(AValue: single);
  procedure SetOpacityTheshold(AValue: single);
...
public
  ...
  property OpacityTheshold: single read FOpacityTheshold write SetOpacityTheshold;
  property NormalOpacity: single read FNormalOpacity write SetNormalOpacity;
...
procedure TStarNestParameter.SetNormalOpacity(AValue: single);
begin
  if FNormalOpacity=AValue then Exit;
  FNormalOpacity:=AValue;
  FChanged := True;
end;

procedure TStarNestParameter.SetOpacityTheshold(AValue: single);
begin
  if FOpacityTheshold=AValue then Exit;
  FOpacityTheshold:=AValue;
  FChanged := True;
end;
...
procedure TStarNestParameter.SetSpeed(AValue: single);
begin
...
begin
  ...
  prop.SingleValueOf('speed', FSpeed, FSpeed);
  ...
  prop.SingleValueOf('opacityTheshold', FOpacityTheshold, FOpacityTheshold);
  prop.SingleValueOf('normalOpacity', FNormalOpacity, FNormalOpacity);
end;
...
begin
  ...
  prop.Add('opacityTheshold', FOpacityTheshold);
  prop.Add('normalOpacity', FNormalOpacity);
