unit u_postprocessing_watermirror;
...
{ TPostProcessingWaterMirror }

TPostProcessingWaterMirror = class(TOGLCBaseRendererForPostProcessing)
private const
  FRAGMENT_SHADER =
   '#version 330 core'#10+
   ...
   // here are the uniforms specific to TPostProcessingWaterMirror
...
procedure TPostProcessingWaterMirror.GetFragmentUniformLocation;
begin
...
procedure TPostProcessingWaterMirror.SetFragmentUniformValues;
begin
...
function TPostProcessingWaterMirror.getWaterColor: TBGRAPixel;
begin
  Result := FWaterColorF.ToBGRA;
end;

procedure TPostProcessingWaterMirror.SetWaterColor(AValue: TBGRAPixel);
begin
  FWaterColorF.InitFromBGRA(AValue);
end;

procedure TPostProcessingWaterMirror.InitShaderCodeAndCallBack;
begin
  FShaderName := 'TPostProcessingWaterMirror';
  FFragmentShaderCode := PChar(FRAGMENT_SHADER);
  FGetFragmentUniformLocation := @GetFragmentUniformLocation;
  FSetFragmentUniformValues := @SetFragmentUniformValues;
...
procedure TPostProcessingWaterMirror.SetParams(const aWaterColor: TBGRAPixel;
